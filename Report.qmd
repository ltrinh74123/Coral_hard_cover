...
This unit encouraged me to seek and learn new statistical techniques actively. While I am familiar with linear forecasting models, this project required me to explore and learn about the characteristics of ARIMAX in order to decide whether it is acceptable. It allowed for more complex data exploration, broadened my analytical toolkit, and helped me better grasp time series. I am grateful for the plentiful opportunities that allowed me to gain more expertise based on staff feedback during our projects, which helped me further develop my statistical foundation and critical thinking skills, as some of the projects I was working on required an understanding of a topic that I would not have learned in other units.
